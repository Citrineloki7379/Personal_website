...
const Navbar = () => {
  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center fixed py-5 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'> 
        ...
        onClick={() => 
          ...
          window.scrollTo(0, 0);
            ...
            font-bold cursor-pointer'>Manav 
            <span className='sm:block hidden'>| Sankriti</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center z-25'>
